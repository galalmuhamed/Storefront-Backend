...
var hashPass = function (pass) {
    var hash = bcrypt_1.default.hashSync(pass + config_1.default.BCRYPT_PASSWORD, parseInt(config_1.default.SALT_ROUNDS));
    return hash;
};
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot Get all Data ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get this User ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
